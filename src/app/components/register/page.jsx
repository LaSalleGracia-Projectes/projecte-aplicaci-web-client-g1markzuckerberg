...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      localStorage.setItem('token', data.tokens.webToken)
      localStorage.setItem('refreshToken', data.tokens.refreshWebToken)
        ...
        <div className="flex flex-col items-center justify-center p-4 min-h-[calc(100vh-128px)]">
          <div className="w-full max-w-md space-y-6 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="confirm-password" className="text-sm font-medium">Repetir contraseña</label>
                <div className="relative">
                  <Input
                    id="confirm-password"
