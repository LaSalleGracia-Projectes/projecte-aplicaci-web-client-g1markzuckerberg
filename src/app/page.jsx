"use client"
import { Box, Typography, Button, Container, Grid, Paper, Divider, Avatar, styled } from "@mui/material"
  ...
  return (
    <Layout>
      <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh", bgcolor: "#eeeeee" }}>
        {/* Banner */}
        <Box
          sx={{ position: "relative", bgcolor: "white", width: "100%", height: 250, borderBottom: "1px solid #d9d9d9" }}
        >
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  {leftMatches.map((match, index) => (
                    ...
                    >
                      ...
                      <Typography sx={{ mx: 1, fontSize: "0.875rem", fontWeight: 500 }}>{t("home.vs")}</Typography>
                      <Box sx={{ display: "flex", alignItems: "center" }}>
