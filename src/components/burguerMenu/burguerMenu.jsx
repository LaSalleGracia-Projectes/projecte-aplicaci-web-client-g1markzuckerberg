...
export default function BurgerMenuContent({ onClose }) {
  ...
  return (
    <div className="w-64 bg-gray-900 text-white p-4 rounded-lg shadow-lg">
      ...
      <Link href="/components/crud"> <button className="w-full bg-orange-500 text-white py-2 rounded-md mt-4 hover:bg-yellow-600" onClick={onClose}> {t("CRUD")} </button> </Link>
